                    ...
                    <div className='mt-10 w-[80vw] border border-gray-700 rounded-xl'>
                        <table className='w-[80vw] text-left'>
                            ...
                            <tbody>
                                ...
                                <tr className="border-b border-gray-800">
                                    <td className="py-4 px-4">Customer Re-engagement</td>
                                    <td className="py-4 px-4"><span className="bg-green-900/30 text-green-400 px-3 py-1 rounded-full">Active</span></td>
                                    <td className="py-4 px-4">Get Replies</td>
                                    <td className="py-4 px-4">842</td>
                                    <td className="py-4 px-4">Oct 14, 2025</td>
                                    <td className="py-4 px-4">Nov 29, 2025</td>
                                    <td className="py-4 px-4 space-x-2">
                                        <button className="hover:text-cyan-400"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 inline" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                        </svg></button>
                                ...
                                <tr className="border-b border-gray-800">
                                    <td className="py-4 px-4">Demo Campaign - Tech Startups</td>
                                    <td className="py-4 px-4"><span className="bg-yellow-900/30 text-yellow-400 px-3 py-1 rounded-full">Paused</span></td>
                                    <td className="py-4 px-4">Book Demo</td>
                                    <td className="py-4 px-4">523</td>
                                    <td className="py-4 px-4">Aug 31, 2025</td>
                                    <td className="py-4 px-4">Oct 30, 2025</td>
                                    <td className="py-4 px-4 space-x-2">
                                        <button className="hover:text-cyan-400"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 inline" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                        </svg></button>
