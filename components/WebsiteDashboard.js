    ...
    return (
        <>
            <main className='min-h-screen ml-0 md:ml-[13.5vw] px-4 md:px-0'>
                ...
                <section className='mx-auto md:mx-[2.5vw] flex flex-col md:flex-row gap-4 md:gap-8 justify-between min-h-[60vh] md:h-[60vh] w-full md:w-[80vw] mt-8 md:mt-28 max-w-7xl'>
