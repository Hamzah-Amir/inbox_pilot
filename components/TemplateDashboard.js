...
const TemplateDashboard = ( {  campaigns, emails, plan, used, limit  } ) => {
    return (
        <>
                                ...
                                <div className='bg-[#08121A] rounded-2xl p-4 shadow-inner border border-gray-800'>
                                    <div className='flex items-center justify-between'>
                                        ...
                                        <div className='flex items-center gap-4'>
                                            ...
                                            <span className='bg-[#0f2b34] text-cyan-300 text-sm px-3 py-1 rounded-full border border-cyan-800'>{plan} plan</span>
                                        </div>
                                    </div>
                                    <div className='mt-3'>
